    ...
    fn into_response(self) -> axum::response::Response {
        let (status_code, message, code) = match &self {
            ...
            AppError::UnauthorizedError => (
                ...
                "認可情報が誤っています".to_string(),
                Some("UNAUTHORIZED"),
            ),
            AppError::ForbiddenOperation => (
                StatusCode::FORBIDDEN,
                "許可されていない操作です".to_string(),
                Some("FORBIDDEN"),
            ),
            ...
            AppError::SpecificOperationError(e) => {
                ...
                (
                    StatusCode::INTERNAL_SERVER_ERROR,
                    "データベース処理エラー".to_string(),
                    Some("DB_OPERATION_ERROR"),
                )
            }
            ...
            AppError::CronjobError(e) => {
                ...
                (
                    StatusCode::INTERNAL_SERVER_ERROR,
                    "JOBスケジューラにエラーが発生しました".to_string(),
                    Some("CRONJOB_ERROR"),
                )
            }
